...
for i in range(num_of_enemies):
    enemyimg.append(pygame.image.load("enemy1 (3).png"))
...
score_value = 0
font = pygame.font.Font("Super Space.otf", 32)
textX = 10
textY = 10

# Game Over
over_font = pygame.font.Font('Super Space.otf', 64)
...
replay_font = pygame.font.Font('Super Space.otf', 32)

# Pause button setup
pause_button_rect = pygame.Rect(700, 0, 150, 40)
pause_font = pygame.font.Font('Super Space.otf', 32)
